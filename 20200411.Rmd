...
[台南市運動地圖](https://data.gov.tw/dataset/6217):
```{r}
library(jsonlite)
...
vectorExample
vectorExample[c(1,3)]
vectorExample[c(3,2,1)]# 重新產生排列效果
```
...
用「要/不要」邏輯向量自taipeiNightMarkets選出寧夏觀光夜市,西昌街觀光夜市,大龍街夜市,雙城街夜市
...
c(T,F,
  ...
  F,F,
  F,T)-> selectedMarkets
taipeiNightMarkets[selectedMarets]
